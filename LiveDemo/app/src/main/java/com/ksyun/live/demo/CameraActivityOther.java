...
public class CameraActivityOther extends Activity {

    private static final String TAG = "CameraActivityOther";
    ...
    private CheckBox mFrontCameraMirror;
    private CheckBox mSoftPreviewFrame;
    ...
    public static void startActivity(Context context, int fromType,
        ...
        Intent intent = new Intent(context, CameraActivityOther.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_activity_other);
        ...
        mFrontCameraMirror = (CheckBox) findViewById(R.id.front_camera_mirror);
        mSoftPreviewFrame = (CheckBox) findViewById(R.id.camer_preview_frame);
                ...
                if (msg != null && msg.obj != null) {
                    ...
                    switch (msg.what) {
                        ...
                        case RecorderConstants.KSYVIDEO_AUDIO_START_FAILED:
                            Toast.makeText(CameraActivityOther.this, content,
        ...
        mSoftPreviewFrame.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        mFrontCameraMirror.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                mStreamer.setEnableCameraMirror(isChecked);
                Toast.makeText(CameraActivityOther.this, isChecked+"", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                new AlertDialog.Builder(CameraActivityOther.this).setCancelable(true)
                        .setTitle("结束直播?")
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                chronometer.stop();
                                recording = false;
                                CameraActivityOther.this.finish();
                            }
                        }).show();
                break;
