...
public class CameraActivityWaterLogo extends Activity {

    private static final String TAG = "CameraActivityWaterLogo";
    ...
    public static void startActivity(Context context, int fromType,
        ...
        Intent intent = new Intent(context, CameraActivityWaterLogo.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_activity_waterlogo);
                ...
                if (msg != null && msg.obj != null) {
                    ...
                    switch (msg.what) {
                        ...
                        case RecorderConstants.KSYVIDEO_AUDIO_START_FAILED:
                            Toast.makeText(CameraActivityWaterLogo.this, content,
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                new AlertDialog.Builder(CameraActivityWaterLogo.this).setCancelable(true)
                        .setTitle("结束直播?")
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                chronometer.stop();
                                recording = false;
                                CameraActivityWaterLogo.this.finish();
                            }
                        }).show();
                break;
