...
public class CameraActivityBeauty extends Activity {

    private static final String TAG = "CameraActivityBeauty";
    ...
    public static void startActivity(Context context, int fromType,
        ...
        Intent intent = new Intent(context, CameraActivityBeauty.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_activity_beauty);
                ...
                if (msg != null && msg.obj != null) {
                    ...
                    switch (msg.what) {
                        ...
                        case RecorderConstants.KSYVIDEO_AUDIO_START_FAILED:
                            Toast.makeText(CameraActivityBeauty.this, content,
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                new AlertDialog.Builder(CameraActivityBeauty.this).setCancelable(true)
                        .setTitle("结束直播?")
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                chronometer.stop();
                                recording = false;
                                CameraActivityBeauty.this.finish();
                            }
                        }).show();
                break;
