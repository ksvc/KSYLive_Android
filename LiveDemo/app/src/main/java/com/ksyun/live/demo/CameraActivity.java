        ...
        mPip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mPicPipMode) {
                    ...
                    mPicPipMode = false;
                    mPicturePip.setText(CameraActivity.this.getResources().getString(R.string.app_name));
                ...
                if (!mPipMode) {
                    ...
                    mPipMode = true;
                    mPip.setText(CameraActivity.this.getResources().getString(R.string.app_name));
                    mPip.postInvalidate();
                } else {
